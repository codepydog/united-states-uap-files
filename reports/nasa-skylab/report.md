...
## SL-2 Technical Crew Debriefing 封面（JSC-08053）

![](sl2-cover.jpg)

文件編號 JSC-08053，1973-06-30。SL-2 任務於 1973-06-22 結束，封面日期是任務後 8 天。

視覺特徵：

- 不像 Apollo 系列，封面沒有 CONFIDENTIAL 印章，未分級
- 上方手寫「BE4 / J. Crinwood」（路由 initials，非機密分級）
- 標題 SKYLAB 1/2，這是 Skylab 計畫第二次發射（SL-1 是 1973-05-14 無人發射太空站本體，SL-2 才是第一次載人任務）
- 左下 NASA 圓形 logo（star + stripe + 紅鳥 silhouette）配 LYNDON B. JOHNSON SPACE CENTER

「PREPARED BY TRAINING OFFICE / CREW TRAINING AND SIMULATION DIVISION」，跟 Apollo 17 是同一單位。

## Kerwin（SL-2 醫官）：light flashes 在閉眼時最頻繁

![](kerwin-eyes-closed.jpg)

頁碼 23-20。章節「Unusual or Unexpected Visual Phenomenon」。
...
## SL-3 Technical Crew Debriefing 封面（JSC-08478）

![](sl3-cover.jpg)

文件編號 JSC-08478，1973-10-04。SL-3 任務於 1973-09-25 結束，封面日期是任務後 9 天。

跟 SL-2 同款封面樣板，差別：

- 文件編號 +425
- 任務名稱 SKYLAB 1/3
- 沒有 SL-2 封面那個手寫「BE4」routing initial

## Garriott（SL-3 科學專家）：紅色亮星比木星還亮，距離 30-50 海里

![](garriott-redstar.jpg)
...
## SL-4 Technical Crew Debriefing 封面（JSC-08809）

![](sl4-cover.jpg)

文件編號 JSC-08809，1974-02-22。SL-4 任務於 1974-02-08 結束，封面日期是任務後 14 天。

視覺特徵：

- 標題下加 PART I，意味原始文件分多冊
- 上方手寫「BE4 / R. Grimwood」（routing initial 換人，與 SL-2 不同）
- 編輯單位變成「CREW TRAINING AND PROCEDURES DIVISION」，從 Simulation Division 改名為 Procedures Division，反映 NASA 載人計畫從 Apollo 過渡到 Shuttle 階段的內部組織重整

## SL-4 機組：「objects up there with us」自轉中

![](tumbling-objects.jpg)
