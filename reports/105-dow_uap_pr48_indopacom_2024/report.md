...
- 背景：水域上整排離岸風機，IR 下顯影成多個三葉黑色剪影
- 鎖定環圈：固定在風機之間水域中央的一處小亮點對比區
- 感測器以 autotrack 或手動 slew 方式將該對比區保持於畫面中央

![~ t=5s 影片開始時對比區](frame-start.jpg)

![~ t=90s 後段持續追蹤](frame-end.jpg)
...
- [#103 PR46 INDOPACOM 2024](../103-dow_uap_pr46_indopacom_2024/report.md)，同戰區同年代，可對照「形態獨特（橄欖球 + 突出物）」與「形態一般化」皆列 unresolved 的原因
- [#104 PR47 INDOPACOM 2023](../104-dow_uap_pr47_indopacom_2023/report.md)，同戰區案件但為多目標相對位置固定，可對照「單目標」與「多目標固定編隊」處理流程
- [#102 PR45 中東 2020](../102-dow_uap_pr45_middle_east_2020/report.md)，跨 AOR 對照「單一中央對比區 + 持續追蹤」的不同 AARO 加註模式
