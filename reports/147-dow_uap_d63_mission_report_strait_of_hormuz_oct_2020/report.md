...
2020-10-01 至 10-02，**482 ATKS / 432 AEW**（Air Force Reserve）的 MQ-9 Reaper 從 OKAS 起飛，21 小時 4 分鐘任務，支援 NAVCENT 在荷莫茲海峽 + 阿曼灣 + 阿拉伯灣特徵化伊朗 / IRGCN 船舶與 UAS 活動，並建立**港口外活動 pattern of life**。這是 [#071 D62](../146-dow_uap_d62_mission_report_strait_of_hormuz_sep_2020/report.md) 之後 **15 天**，同單位、同基地、同戰區的下一次任務。

D62 那次累積到 3 次伊朗喊話 + 2 次 EMI 失聯 + 1 個 UAP。D63 把喊話次數推到 **5 次**，去掉了 EMI，多出一筆機場觀測。
...
D63 提供 D 系列至今**最完整的喊話 tone progression**。

前兩次（0727Z, 0854Z）標為 **PROFESSIONAL**。中間第三次（1122Z）tone 變成 **Directive**。第四次（1236Z）回到 Professional。第五次（1315Z）又是 **Directive**。

所有 5 次都記為 NO IMPACT TO THE MISSION，STANDARD CALL / STANDARD RESPONSE 1。每次只有 1 通同 agency 的喊話，意味伊朗防空換了 5 個不同位置 / 5 個不同時段對同一架 MQ-9 喊話，而不是一個位置連續打。

從 FL180 → FL160 的下降配合喊話頻率升高，看起來像 D62 的鏡像：D62 是 FL040 低空時被喊話，D63 是 FL160 中空層被反覆喊話。

## Abu Musa Island 是哪裡

12:44Z 跟 13:44Z 的兩次觀測都指向同一個座標，**Abu Musa Island**。

Abu Musa 在荷莫茲海峽南口、阿拉伯灣與阿曼灣交界處，是伊朗自 1971 年佔領的爭議性島嶼（UAE 主張主權）。島上有一條 1,800 公尺長跑道，IRGC（伊朗革命衛隊）駐軍與防空雷達都佈在這裡。**ATR 72-500** 是法義 ATR 公司製的雙發渦輪螺旋槳客機，伊朗 Iran Air、Mahan Air、IRGC-AF 都用過。在 IRGC 偏遠島嶼基地的跑道上停一架 ATR 72-500 不算稀奇，但「美軍 MQ-9 用 ANDAS4 雷達 + 光電 ISR 把跑道上停哪一架民航構型飛機拍清楚」就是這次任務的重點之一。

## 16:57Z 的 Naser WAP + Busherh IRIN boatyard

第三筆地面觀測：**1 個可能 Naser WAP 停泊在 2 個 Busherh IRIN boatyard 旁**。

**Naser** 是伊朗革命衛隊海軍（IRGCN）的快攻艇之一，常用於荷莫茲海峽附近騷擾國際航運。**Busherh**（即 Bushehr，譯為布什爾）位於伊朗西南海岸阿拉伯灣畔，**IRIN** 是伊朗正規海軍（Islamic Republic of Iran Navy），與 IRGCN 是兩個不同的海上力量。

Naser 屬於 IRGCN，停在 IRIN 的 boatyard 旁有兩種解讀：(1) **跨單位停泊**，IRGCN 借用 IRIN 設施維修或補給；(2) 報告寫法可能把 boatyard 歸 IRIN 是因為位置在 Bushehr 港，而 Naser 只是路過停靠。MQ-9 把這筆觀測寫進 MISREP，意味 **NAVCENT 對 IRGCN vs IRIN 兩股海軍的混合活動有持續關注**。
...
重霾這條最關鍵。D63 整份任務的 IMINT 評估等級可能被霾打折，意味 UAP 觀測的視覺證據強度比 D62（高能見度 FL040）低很多。如果 UAP 被霾遮，FMV 看到的可能只是熱反差殘影或雷達粗略 hit。
...
ANDAS4 是 MQ-9 的合成孔徑雷達（SAR + MTI），理論上**不受霾影響**，SAR 用 X-band 微波，能穿過水氣與灰塵。

但 D63 narrative 寫 weather 是 **HEAVY HAZE PRECLUDED IMINT ANALYSIS**。IMINT（Imagery Intelligence）通常指光電 / 紅外影像，**MX-20 EO/IR sensor 才會被霾影響**。這意味 D63 任務的 IMINT 主軸是 MX-20 EO/IR（用來看 Abu Musa 跑道上的飛機型號），而不是 ANDAS4 SAR。霾妨礙了用 EO/IR 對地面目標的精細判讀。

UAP 在 18:29Z 看到，那個時段中東地區進入黃昏 / 黑夜過渡，霾的影響更大。**這降低了 D63 UAP 觀測的證據強度**，但也說明為什麼 narrative 沒有給 shape / altitude / speed。
...
- [#071 D62 荷莫茲 2020-09-16](../146-dow_uap_d62_mission_report_strait_of_hormuz_sep_2020/report.md)：15 天前同 MQ-9、3 次伊朗喊話 + 38 分鐘 EMI + UAP。
- [#070 D61 阿拉伯灣 2020-08-27](../145-dow_uap_d61_mission_report_persian_gulf_aug_2020/report.md)：35 天前同單位、FORMATION UAP。
- [#069 D60 阿拉伯灣 2020-08-08](../144-dow_uap_d60_mission_report_persian_gulf_aug_2020/report.md)：54 天前同單位、UAP TRANSITTING。
