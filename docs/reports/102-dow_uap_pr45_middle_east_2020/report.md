...
![~ t=5s 開始時對比區較小](frame-start.jpg)

![~ t=30s 中段對比區可見變大](cover.jpg)

![~ t=55s 後段對比區進一步放大](frame-end.jpg)
...
- [#097 PR40 中東 2020](../097-dow_uap_pr40_middle_east_2020/report.md)，同為 PR 系列中少數 AARO 主動加註的案件（U/I 白圈標籤 vs slant range 縮短），可對照兩種加註型態
- [#101 PR44 中東 2020](../101-dow_uap_pr44_middle_east_2020/report.md)，同樣以 autotrack 持續鎖定中央對比區，但片長更長（5:12）並含 FOV 收窄
- [#098 PR41 中東 2020](../098-dow_uap_pr41_middle_east_2020/report.md)，同為以 sensor 行為（手動 slew）揭露運動學資訊的案件，可對照「平台移動 vs 操作員選擇」對 unresolved 結論的影響
